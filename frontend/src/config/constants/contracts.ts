...
export default {
  ...
  wneon: {
    [ChainId.TESTNET]: process.env.REACT_APP_WNEON,
    [ChainId.MAINNET]: process.env.REACT_APP_WNEON,
  },
  busd: {
  ...
  neonPcnLp: {
    [ChainId.TESTNET]: process.env.REACT_APP_NEONPCNLP,
    [ChainId.MAINNET]: process.env.REACT_APP_NEONPCNLP,
  },
  neonBusdLp: {
    [ChainId.TESTNET]: process.env.REACT_APP_NEONBUSDLP,
    [ChainId.MAINNET]: process.env.REACT_APP_NEONBUSDLP,
  }
}
