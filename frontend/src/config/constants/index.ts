...
import { BUSD, PCN, WNEON, } from './tokens'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [BUSD[ChainId.MAINNET], PCN[ChainId.MAINNET], WNEON],
  [ChainId.TESTNET]: [WETH[ChainId.TESTNET], PCN[ChainId.TESTNET], BUSD[ChainId.TESTNET]],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [PCN[ChainId.MAINNET], WNEON[ChainId.MAINNET]],
    [BUSD[ChainId.MAINNET], WNEON[ChainId.MAINNET]]
  ],
}
