...
export default {
  ...
  "tags": {},
  "logoURI": "https://raw.githubusercontent.com/Neon-Blockchain/token-icons/main/icons/neon.svg",
  "keywords": [
    "pancake",
    "default"
  ],
  "tokens": [
    {
      "name": "WNEON Token",
      "symbol": "WNEON",
      "address": `${ContractAddress.wneon[ContractAddress.networkId]}`,
