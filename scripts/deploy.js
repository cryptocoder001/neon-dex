...
async function main() {
	...
	// dex
	const Factory = await ethers.getContractFactory("NeondexFactory");
	...
	const Router = await ethers.getContractFactory("NeondexRouter");
	...
	tx = await exchangeRouter.addLiquidity(
		...
		ethers.utils.parseUnits(String(amountPopcorn), 18),
		0,
		0,
		deployer.address,
